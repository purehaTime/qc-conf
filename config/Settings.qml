...
Singleton {
    ...
    // ─── Панель ─────────────────────────────────────────────────────────────
    // Масштаб всей панели: шрифты, иконки, высота, отступы, скругления и
    // ширина док-окон. 1.0 — базовый, 1.25 — крупнее, 0.9 — плотнее.
    // Quickshell перечитывает конфиг при сохранении файла, так что значение
    // можно подбирать вживую.
